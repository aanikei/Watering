...
struct WateringData {
  ...
  int32_t mode; ///< currently 2 modes, automatic (if current time > wateringTime + 86200 * interval AND all soil sensors show moisture level below threshold) and manual
